        ...
        navigation.innerHTML =
            `<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item">
                        <a href="/home.html" class="nav-link active" aria-current="page" id="dropdownLogos">
                    ...
                    <li class="nav-item">
                        <a href="/services.html" class="nav-link link-dark" aria-current="page" id="dropdownLogos">
